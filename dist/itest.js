...
const testDownloadSpeed = (url_1, expectedSizeMB_1, ...args_1) => __awaiter(void 0, [url_1, expectedSizeMB_1, ...args_1], void 0, function* (url, expectedSizeMB, options = defaultOptions) {
            ...
            const req = httpModule.get(url, requestOptions, (res) => {
                ...
                if (res.headers["content-length"]) {
                    ...
                    if (Math.abs(contentLength - expectedBytes) > expectedBytes * 0.1) {
                        console.warn(chalk.yellow("Warning: Content-Length differs significantly from expected size."));
                    }
                }
    ...
    console.log(chalk.green(`Download Speed: ${averageSpeed.toFixed(2)} Mbps (Total Data: ${totalReceivedMB.toFixed(2)} MB, Duration: ${durationInSeconds.toFixed(2)} sec)`));
    return averageSpeed;
});
